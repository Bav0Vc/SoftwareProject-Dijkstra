...
| theoretical | Drag and Drop   | Arrange the main steps of dijkstras algorithm in the correct order:                 |
...
| theoretical | Drag and Drop | What works with Dijkstra's algorithm?                 |
| theoretical | Drag and Drop | Sort the actions. What is allowed in Dijkstra's Algorithm and what is forbidden/impossible?                  |
| theoretical | Drag and Drop | Sort the features. Which traits belong to the real Dijkstra Algorithm, and which belong to other algorithms (like A*, DFS, or Bellman-Ford)?                 |
